...
public interface MessengerService {
    ...
    PlayerMessenger getServerPlayerMessenger();

    boolean isServerPlayerMessengerEnabled();

    PlayerMessenger getProxyPlayerMessenger();

    boolean isProxyPlayerMessengerEnabled();
}
